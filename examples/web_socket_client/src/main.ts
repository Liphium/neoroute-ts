...
import { Receiver, WebSocketTransporter } from "@liphium/neoroute-client";
import { registerReceiver } from "./receiver";
import * as readline from "node:readline";
import { sendEchoRequest, sendSubmitPunRequest } from "./requests";
...
async function main() {
    ...
    console.log('Type "Echo " followed by a message to receive a echo message from the server.');
